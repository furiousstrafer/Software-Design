...
Please feel free to create a build file and verify it works by running a canary test and that it produces code coverage. If you like for Venkat to take a look at it before the final exam, please drop him an email. The earlier you do this the higher the chances of your success. Venkat will be glad to review that your build works if requested anytime before November 16th 11:59PM (simply drop an email). Any request after that may not receive a response. Venkat will not send reminders for this. It is up to you to proactively start early and ask for this review.

Unlike the pair repository, the final repository does not have CI integration and you will not receive any email notifications when you check in.

Details previously sent over the mailing list:

Getting ready for the final exam—Monday November 18 7PM to 10PM CT

Class,

The final coding exam will be from 7:00PM to 10:00PM CT on Monday November 18
...
1. You should work alone. You may consult materials on the internet and books. However, while working on the exam, you should not consult with another person in the class, outside the class, over the internet, SMS, etc. Also, you can look up syntax or API, but you are not allowed to use a software application to generate your solution/code.
...
7. There will be no CI/Jenkins for the final exam.
...
1. Do not seek direct help, from any person or system, during the exam
...
3. Do not post questions on forums and ask for help through the forums or an application on the internet
